...
from .models import User, Role, Telefonos
...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:12345678@localhost/flasksecurity'
    ...
    from .telefonos import telefonos as telefonos_blueprint  
